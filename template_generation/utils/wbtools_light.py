...
def curv_warp_to_sulc(create_work_dir,simi_method):
    ...
    f.write('#!/bin/bash\n'
            ...
            'wb_command -metric-resample /HPC_work_dir/affined_sulc/${mov_id}.sulc.affine.ico6.shape.gii '
            '${WARP} '
            '/HPC_work_dir/sunet.ico-6.surf.gii '
            'ADAP_BARY_AREA '
...
def msm_reg_template_2(create_work_dir,firstreg,iter_num,lobe,simi_method): # run 2 direction in parallel
    ...
    if firstreg==1:
        ...
        f.write('#!/bin/bash\n'
                ...
                'create_work_dir='+str(create_work_dir)+'\n'
                'newmsm '
                '--inmesh=/HPC_work_dir/sunet.ico-6.surf.gii ' 
                '--refmesh=/HPC_work_dir/sunet.ico-6.surf.gii '
                '--indata=/HPC_work_dir/affined_sulc/${mov_id}.sulc.affine.ico6.shape.gii '
                ...
                'if [ ! -d "/HPC_work_dir/'+lobe+'_lobe/rotated_deformed_'+lobe+'_lobe_'+simi_method+'" ];then\n'
                '    mkdir /HPC_work_dir/'+lobe+'_lobe/rotated_deformed_'+lobe+'_lobe_'+simi_method+';\n'
                'fi \n'
                'wb_command -metric-resample /HPC_work_dir/affined_features/${mov_id}.curv.affine.ico6.shape.gii '
                ...
                '${create_work_dir}/'+simi_method+'_affine_mask/check${tar_id}_msmrefine/${mov_id}.MSM_sulc.${tar_id}.sphere.reg.surf.gii '
                '/HPC_work_dir/sunet.ico-6.surf.gii;\n'
                'wb_command -metric-resample /HPC_work_dir/'+lobe+'_lobe/rotated_'+lobe+'_lobe/${mov_id}.'+lobe+'.ico6.shape.gii '
                '${create_work_dir}/'+simi_method+'_affine_mask/check${tar_id}_msmrefine/${mov_id}.MSM_sulc.${tar_id}.sphere.reg.surf.gii '
                '/HPC_work_dir/sunet.ico-6.surf.gii '
                'ADAP_BARY_AREA '
                '/HPC_work_dir/'+lobe+'_lobe/rotated_deformed_'+lobe+'_lobe_'+simi_method+'/${mov_id}.'+lobe+'.ico6.shape.gii '
                '-area-surfs '
                '${create_work_dir}/'+simi_method+'_affine_mask/check${tar_id}_msmrefine/${mov_id}.MSM_sulc.${tar_id}.sphere.reg.surf.gii '
                '/HPC_work_dir/sunet.ico-6.surf.gii;\n'
                'wb_command -metric-math '
                '\'round(x)\' /HPC_work_dir/'+lobe+'_lobe/rotated_deformed_'+lobe+'_lobe_'+simi_method+'/${mov_id}.'+lobe+'.ico6.shape.gii '
                '-var x /HPC_work_dir/'+lobe+'_lobe/rotated_deformed_'+lobe+'_lobe_'+simi_method+'/${mov_id}.'+lobe+'.ico6.shape.gii;')
        ...
        f.write('#!/bin/bash\n'
                ...
                '--inmesh=/HPC_work_dir/sunet.ico-6.surf.gii '
                '--refmesh=/HPC_work_dir/sunet.ico-6.surf.gii '
                '--indata=/HPC_work_dir/affined_features/${mov_id}.curv.affine.ico6.shape.gii '
...
def generate_average_metric_command(leaf_combine,root_path,merge_id,affine_path,file_suffix,firstreg,iter_num,lobe,create_work_dir,simi_method):
    ...
    if firstreg != 1:
        command = command + 'wb_command -metric-math \'abs(x-y)\' '+create_work_dir+'/'+simi_method+'_affine_mask/check'+merge_id+'_msmrefine/difference.shape.gii '+\
                ...
                'diff=$(wb_command -metric-stats '+create_work_dir+'/'+simi_method+'_affine_mask/check'+merge_id+'_msmrefine/difference.shape.gii -reduce MEAN -roi /HPC_work_dir/'+lobe+'_lobe/rotated_deformed_'+lobe+'_lobe_'+simi_method+'/'+merge_id+'_'+lobe+'_mask.shape.gii);\n'+\
                'echo $diff;\n'
    if firstreg == 1:
        for i,leaf in enumerate(leaf_combine):
            msks = np.append(msks,
                             '-metric /HPC_work_dir/'+lobe+'_lobe/rotated_deformed_'+lobe+'_lobe_'+simi_method+'/' + leaf + '.'+lobe+'.ico6.shape.gii')
            msks = ' '.join(msks)
        command = command + 'wb_command -metric-merge /HPC_work_dir/'+lobe+'_lobe/rotated_deformed_'+lobe+'_lobe_'+simi_method+'/'+merge_id+'_'+lobe+'_merged.shape.gii '+msks+';\n'
        command = command + 'wb_command -metric-reduce /HPC_work_dir/'+lobe+'_lobe/rotated_deformed_'+lobe+'_lobe_'+simi_method+'/'+merge_id+'_'+lobe+'_merged.shape.gii MAX /HPC_work_dir/'+lobe+'_lobe/rotated_deformed_'+lobe+'_lobe_'+simi_method+'/'+merge_id+'_'+lobe+'_mask.shape.gii;\n'
